...
{
    public class WaterRegionController : Controller
	{
		private readonly ILogger<WaterRegionController> _logger;

		public WaterRegionController(ILogger<WaterRegionController> logger)
		{
			_logger = logger;
		}
